      ...
      <div className="grid col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-4 even:mt-2.5">
        <div className="w-fit h-fit p-1.5 bg-[#F5F8FA] rounded-xl">
          <div className="bg-background drop-shadow-md backdrop-blur-md p-6 rounded-xl">
            ...
            <div className="">
              <p className="text-sm text-secondary/60">
                I&apos;ve stumbled upon a game-changer in the online shopping world. Finding and purchasing products has never been easier. I&apos;ve
                managed to acquire numerous items without any fuss. The seamless process and diverse product offerings have made this platform my
                go-to destination for all my shopping needs.{" "}
              </p>
            </div>
          </div>
        </div>
