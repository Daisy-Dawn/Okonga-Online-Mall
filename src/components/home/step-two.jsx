...
export default function StepTwo() {
  return (
    <section className="w-full min-h-screen grid justify-center lg:place-items-center px-6 md:px-12 py-12">
      <div className="w-full h-full flex-col lg:flex lg:flex-row-reverse items-center justify-center lg:justify-between gap-16">
        ...
        <div className="w-full flex flex-1 my-8 lg:my-0">
          <figure>
