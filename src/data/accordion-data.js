export const accordions = [
  {
    id: 1,
    title: "When will I collect the item that I am paying for?",
    body: "Your item will be shipped when you reach the middle of your installment period and have paid at least half of the item's cost in equal installments. The delivery timing varies based on the chosen installment plan, such as immediate delivery for a 2-month plan and delivery starting in the 3rd or 6th month for longer plans.",
  },
  {
    id: 2,
  ...
  {
    id: 4,
    title: "Can I collect my money back if I change my mind?",
    body: "Yes, however, this incurs a 10% fee on the sum already paid in installments to discourage unnecessary order cancellations.",
  },
  {
    id: 5,
